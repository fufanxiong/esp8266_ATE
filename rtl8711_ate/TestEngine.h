...
#define TE_ERROR_MIBCMD_NO_SESSION                                      0x000200
#define TE_ERROR_MIBCMD_GET_ERROR                                       0x000300
#define TE_ERROR_MIBCMD_SET_ERROR                                       0x000400
...
*************************************************************************************/
TESTENGINE_API(uint32) openTestEngineSpiUnlock(int32 port, int32 multi,
                                               int32 transport,
                                               const char* unlockKey);
...
*************************************************************************************/
TESTENGINE_API(uint32) openTestEngineSpiUnlockTrans(char const * const trans,
                                                    int32 multi,
                                                    const char* unlockKey);
...
*************************************************************************************/
TESTENGINE_API(int32) radiotestPcmExtLbIf(uint32 handle, uint16 pcm_mode, 
                                           uint16 pcm_if);
...
*************************************************************************************/
TESTENGINE_API(int32) radiotestPcmTimingInIf(uint32 handle, uint16 pio_out, 
                                              uint16 pcm_in, uint16 pcm_if);
        ...
        if(handle != 0)
        {
            ...
            else
            {
                ...
                if(success != TE_OK)
                {
                    ...
                    if(errLines != 0)
                    {
                        cout << "ERROR: Lines that could be set = " << errLines << endl;
                    }
                }
            }
...
/*************************************************************************************
    ...
    Description :   This function can be used to merge a CSR *.psr format persistent 
                    store file into the persistent store of a BlueCore chip. Patch 
                    files for ROM chips in *.psr format can be loaded using this 
                    function.
...
*************************************************************************************/
TESTENGINE_API(int32) bccmdI2CTransfer(uint32 handle, uint16 slaveAddr, uint16 txOctets,
...
/*************************************************************************************
    ...
    Function :      int32 bccmdCapSenseRead(uint32 handle, uint16 mask, uint16 * values)
...
*************************************************************************************/
TESTENGINE_API(int32) bccmdCapSenseRead(uint32 handle, uint16 mask, uint16 values[]);
...
*************************************************************************************/
TESTENGINE_API(int32) teGetPtapHifs(
    uint16* length,
    char* hifIds,
    char* types,
    char* names,
