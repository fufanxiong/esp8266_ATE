...
#define TFL_ERROR_SPIUNLOCK        0x1009 //Indicates an error connected with SPI-unlocking
...
/*************************************************************************************
    ...
    Description :   This function is one of the flInit... set of functions
                    used to create the appropriate host side objects 
                    to enable flash programming via the SPI or gang programming 
                    interface.
                    <p>To be used (only) with devices which are not SPI-locked.                    
                    flInitTrans can also be used to do this.
                    <p>flInitSpiUnlock or flInitSpiUnlockTrans should be
                    used with SPI-locked devices.
                    <p>This is an entry point to the single connection version of 
                    TestFlash. This can be used when flashing a single device, and 
                    must be used when using a parallel port gang programmer with
                    devices which are not SPI-locked.
...
/*************************************************************************************
    ...
    Function :      int32 flInitSpiUnlock(int32 port, int32 xtal, int32 delays,
    ...
    Description :   This function is one of the flInit... set of functions
                    ...
                    to enable flash programming via the SPI or gang programming 
                    interface.
                    <p>To be used (only) with SPI-locked devices.                    
                    flInitSpiUnlockTrans can also be used to do this.
                    <p>flInit or flInitTrans should be
                    used with devices which are not SPI-locked.
                    <p>This is an entry point to the single connection version of 
                    TestFlash. This can be used when flashing a single device, and 
                    must be used when using a parallel port gang programmer with
                    SPI-locked devices.
...
*************************************************************************************/
TESTFLASH_API(int32) flInitSpiUnlock(int32 port, int32 xtal, int32 delays, int32 transport, const char* unlockKey);
...
/*************************************************************************************
    ...
    Description:    This is the multiple connection version of flInit. See flInit for
                    ...
                    <p>flmOpenSpiUnlock or flmOpenSpiUnlockTrans should be
                    used with SPI-locked devices.
                    ...
                    <p>This is an entry point for the multiple connection version of
                    TestFlash. This must be used when flashing multiple devices which
                    are not SPI-locked, but not when using a parallel port gang
                    programmer to do so.
...
/*************************************************************************************
    ...
    Function :      int32 flmOpenSpiUnlock(uint32 deviceMask, int32 xtal,
                                           int32 transport, const char* unlockKey);
    ...
    Description:    This is the multiple connection version of flInitSpiUnlock.
                    See flInitSpiUnlock for more details.
                    <p>To be used (only) with SPI-locked devices.                                   
                    flmOpenSpiUnlockTrans can be used as an alternative to
                    flmOpenSpiUnlock.
                    <p>flmOpen or flmOpenTrans should be used with devices
                    which are not SPI-locked.
                    <p>This function will fail if the chip(s) cannot be communicated 
                    with. If the return value is TFL_DEVICE_ERROR, use 
                    flmGetBitErrorField to determine which devices failed or succeeded.
                    <p>This is an entry point for the multiple connection version of
                    TestFlash. This must be used when flashing multiple SPI-locked
                    devices, but not when using a parallel port gang programmer to
                    do so.
                    <p>flmOpenSpiUnlock can either be called with a mask specifying
                    all devices to open, or it can be called multiple times to open
                    multiple devices (the devices in the mask must be different for
                    each call). In the case of multiple calls to flmOpen, the
                    transport type must be the same for each call - you cannot have
                    an LPT-SPI device and a USB-SPI device open at the same time.

*************************************************************************************/
TESTFLASH_API(int32) flmOpenSpiUnlock(uint32 deviceMask, int32 xtal, int32 transport,
...
/*************************************************************************************
    ...
    Description :   This function is one of the flInit... set of functions
                    ...
                    interface.
                    <p>To be used (only) with devices which are not SPI-locked.                    
                    flInit can also be used to do this.
                    <p>flInitSpiUnlock or flInitSpiUnlockTrans should be
                    used with SPI-locked devices.
...
/*************************************************************************************
    ...
    Function :      int32 flInitSpiUnlockTrans(char const * const trans, int32 xtal, 
    ...
    Description :   This function is one of the flInit... set of functions
                    ...
                    to enable flash programming via the SPI or gang programming 
                    interface.
                    <p>To be used (only) with devices which are SPI-locked.                    
                    flInitSpiUnlock can also be used to do this.
                    <p>flInit or flInitTrans should be used with devices
                    which are not SPI-locked.
                    <p>The trans string may be one of those returned by 
                    flGetAvailableSpiPorts, which returns transport strings for all 
                    available SPI ports.
...
*************************************************************************************/
TESTFLASH_API(int32) flInitSpiUnlockTrans(char const * const trans, int32 xtal,
                                          int32 delays, const char* unlockKey);
...
/*************************************************************************************
    ...
    Function :      int32 flmOpenSpiUnlockTrans(uint32 deviceMask,
                                                char const * const trans,
    ...
    Description :   This is the multiple connection version of flInitSpiUnlockTrans.
                    See flInitSpiUnlockTrans for more details.
                    flmOpenSpiUnlock can also be used as an alternative to
                    flmOpenSpiUnlockTrans.
                    <p>To be used (only) with SPI-locked devices.                                   
                    <p>flmOpen or flmOpenTrans should be used with devices which are
                    not SPI-locked.
                    <p>This function will fail if the chip(s) cannot be communicated 
                    with. If the return value is TFL_DEVICE_ERROR, use 
                    flmGetBitErrorField to determine which devices failed / succeeded.
 ...
 *************************************************************************************/
TESTFLASH_API(int32) flmOpenSpiUnlockTrans(uint32 deviceMask,
                                           char const * const trans, int32 xtal,
                                           const char* unlockKey);
...
/*************************************************************************************
    ...
    Function :      int32  flmSetPios(uint32 deviceMask, uint8 pioSclk, uint8 pioMiso, uint8 reserved)
...
*************************************************************************************/
TESTFLASH_API(int32) flmSetPios(uint32 deviceMask, uint8 pioSclk, uint8 pioMiso, uint8 reserved);
